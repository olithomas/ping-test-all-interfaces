...
class Ping(object):
    def __init__(self, destination, id_str, timeout=1000, packet_size=55, own_id=None, quiet_output=True, udp=False, sourceaddress=False):
    ...
    def print_success(self, delay, ip, packet_size, ip_header, icmp_header):
        ...
        msg = "%s\t%d bytes from %s: icmp_seq=%d ttl=%d time=%.1f ms" % (self.id_str, packet_size, from_info, icmp_header["seq_number"], ip_header["ttl"], delay)
    ...
    def print_failed(self):
        msg = "%s\tRequest timed out." % (self.id_str)
